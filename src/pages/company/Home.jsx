  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-16 md:py-24 bg-gradient-to-r from-blue-50 via-white to-blue-100 w-screen">
        <div className="absolute inset-0 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 opacity-30 -z-10 w-[100px] "></div>
      ...
      { /* How We Do It Section  AI Genworks*/ }
      <section className="py-16 md:py-24 bg-gradient-to-r from-blue-50 via-white to-blue-100 w-screen">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
          <div className="space-y-8 md:space-y-10 order-2 md:order-1">
            {[
              ...
              <div
                key={idx}
                className="bg-white p-6 md:p-8 lg:p-10 rounded-xl shadow-xl border-l-8 border-gray-700 w-full cursor-pointer transition-transform transform hover:scale-105"
                onClick={() => navigate(item.path)}
              >
                <h4 className="text-2xl md:text-3xl font-bold text-gray-800 mb-4">{item.title}</h4>
                <p className="text-lg md:text-xl text-gray-700">{item.description}</p>
              </div>
            ))}
          </div>
          <div className="flex items-center justify-center w-full h-full order-1 md:order-2 mb-10 md:mb-0">
            <motion.div 
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
      <div className="space-y-8 md:space-y-10 order-2 md:order-1">
        {[
          ...
          <div
            key={idx}
            className="bg-white p-6 md:p-8 lg:p-10 rounded-xl shadow-xl border-l-8 border-gray-700 w-full transition-transform transform hover:scale-105"
